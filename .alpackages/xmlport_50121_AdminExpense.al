xmlport 50121 AdminExpenseImport
{
    //Format = VariableText;
    schema
    {
        textelement(root)
        {
            ...
            {
                //** Import Purchase Header Fields
                textelement(VendorName) { }
                textelement(VendorRefNo) { }
                ...
                textelement(AcctNo) { }
                textelement(DueDate) { }
                textelement(ServiceAddr) { }
                textelement(NoOfShipment) { }

                //** Impprt Purchase Line Fields
                /*
                ...
                */
                ...
                begin
                    ...
                    If IntHeader = 1 then begin
                        ...
                        //** Evaluate Purchase Header Fields
